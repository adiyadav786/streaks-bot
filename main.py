...
async def update_nickname(member, level):
    ...
    # Try to make the new nickname fit
...
@bot.tree.command(name="blacklist", description="Manage XP blacklist channels.")  # subcommands!
